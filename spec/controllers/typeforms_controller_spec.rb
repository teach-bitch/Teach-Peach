...
RSpec.describe TypeformsController, type: :controller do
  ...
  # Typeform. As you add validations to Typeform, be sure to
  ...
  # TypeformsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created typeform" do
        post :create, params: {typeform: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Typeform.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the typeform" do
        ...
        expect(response).to redirect_to(typeform)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        typeform = Typeform.create! valid_attributes
        put :update, params: {id: typeform.to_param, typeform: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the typeforms list" do
      typeform = Typeform.create! valid_attributes
      delete :destroy, params: {id: typeform.to_param}, session: valid_session
      expect(response).to redirect_to(typeforms_url)
    end
  end
